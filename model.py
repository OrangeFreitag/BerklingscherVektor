...
# 1. Load Data
train_x = np.loadtxt("./output/berkling_train_x_DFKI.csv" ,delimiter='\t', usecols=range(83)[1:-1], skiprows=1)
train_y = np.loadtxt("./output/berkling_train_y_DFKI.csv", delimiter='\t', usecols=range(2)[1:], skiprows=1)
